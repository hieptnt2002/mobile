class PostApi {
  Future<dynamic> getPosts({int pageIndex = 0}) async {
      ...
      [
        {
          ...
          "thumbnail": "https://clinic.dmm.com/column/wp-content/themes/clinic-column/assets/images/common/tmb_aga-male_pc@2x.webp",
...
''';
    ...
    [
      {
        "id": "1",
        "title": "First Post Title with a bit more detail to make itu",
        "content": "This is the content of the first post. It has multiple lines to ensure it is lengthy enough. We add more details here to make sure it covers at least four lines of text in the content field. This should be sufficient for testing.",
        "thumbnail": "https://clinic.dmm.com/column/wp-content/themes/clinic-column/assets/images/common/tmb_body-support_pc@2x.webp",
        "author": "John Doe",
        "category": "Technology",
        "createdAt": "2024-06-11T08:00:00.000Z"
      },
      {
        "id": "2",
        "title": "Second Post Title that includes more description here to make it span at least three lines for proper testing",
        "content": "This is the content of the second post. It provides insights and details extending over multiple lines. We make sure the content is long enough to meet the requirements. Adding more descriptive text to ensure it spans four lines.",
        "thumbnail": "https://clinic.dmm.com/column/wp-content/themes/clinic-column/assets/images/common/tmb_body-support_pc@2x.webp",
        "author": "Jane Smith",
        "category": "Travel",
        "createdAt": "2024-06-11T08:00:00.000Z"
      ...
      {
        "id": "3",
        "title": "Fourth Post Title with adequate details making it span at least three lines for the sake of testing",
        "content": "This is the content of the first post. It has multiple lines to ensure it is lengthy enough to span four lines in the UI.",
        "thumbnail": "https://clinic.dmm.com/column/wp-content/themes/clinic-column/assets/images/common/tmb_aga-male_pc@2x.webp",
        "author": "David Wilson",
        "category": "Fitness",
        "createdAt": "2024-06-11T08:00:00.000Z"
      ...
      {
        "id": "4",
        "title": "First Post Title that is sufficiently.",
      ...
      {
        "id": "5",
        "title": "Third Post Title providing enough details to span three lines effectively for thorough testing purposes",
        "content": "This is the content of the third post. Ensuring it has enough text to cover multiple lines. Adding more content to ensure it meets the four-line requirement. This additional text should make the content sufficient.",
        "thumbnail": "https://clinic.dmm.com/column/wp-content/themes/clinic-column/assets/images/common/tmb_body-support_pc@2x.webp",
      ...
      },
      {
        "id": "6",
        "title": "Fourth Post Title with adequate details making it span at least three lines for the sake of testing",
        "content": "This is the content of the fourth post. It should have enough information to span four lines. Adding more text to ensure it meets the length requirement. This should be enough to cover the content length.",
        "thumbnail": "https://clinic.dmm.com/column/wp-content/themes/clinic-column/assets/images/common/tmb_body-support_pc@2x.webp",
        "author": "Emily Brown",
        "category": "Fashion",
        "createdAt": "2024-06-11T08:00:00.000Z"
      ...
      {
        "id": "7",
        "title": "This is the content of the seventh post",
...
''';
  ...
  Future<dynamic> getPostDetailById(String id) async {
    await Future.delayed(const Duration(seconds: 1));
    return '''
<!DOCTYPE HTML>
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <article>
        ...
        <p>
          This is a text paragraph that contains some inline links. Generally, inline links (as opposite to e.g. links lists) are problematic from the <a href="http://www.useit.com">usability</a> perspective, but they may have use as &#8220;incidental&#8221;, less relevant links. See the document <cite><a href="links.html">Links Want To Be Links</a></cite>.
        </p>
      </article>
      <article>
        <h2>Forms</h2>
        <form action="somewhere.cgi">
          ...
          <div><label for="f0">Reset button: <input id="f0" type="reset" name="reset" value="Reset"></label></div>
          ...
          <div>
            <label for="f11">A <code>select</code> element with <code>size="3"</code> (listbox):</label><br>
          ...
          <div>
            ...
            <input id="f99" type="submit" name="submit" value="Just a test"></label>
          </div>
        </form>
      </article>
      <article>
        <h2>Tables</h2>
        <p>
          The following table has a caption. The first row is in a thead, the second row is the tfoot, and the rest is in a tbody. The first column contain table header cells (<code>th</code> elements) only; other cells are data cells (<code>td</code> elements):
        </p>
