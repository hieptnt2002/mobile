...
import 'package:make_appointment_app/presentation/screens/update_appointment/widgets/update_appointment_time_item.dart';
...
class _UpdateAppointmentScreenState extends State<UpdateAppointmentScreen> {
  ...
  late MedicalTreatment? _medicalTreatment = _appointment.medicalTreatment;
  bool get showCalendarPicker => _medicalTreatment != null;
  late DateTime _dateSelected = _appointment.bookingDate;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(context.t.appointment.titleUpdateAppointmentAppBar),
      ),
      body: Consumer<UpdateAppointmentViewModel>(
      ...
      sliver: SliverGrid(
        ...
        delegate: SliverChildBuilderDelegate(
          (context, index) {
            ...
            return UpdateAppointmentTimeItem(
